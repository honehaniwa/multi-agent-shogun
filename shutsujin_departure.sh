...
# 軍師（Gemini MCP）確認
# ═══════════════════════════════════════════════════════════════════════════════
if [ -f "$HOME/.claude.json" ] && grep -q '"gemini"' "$HOME/.claude.json" 2>/dev/null; then
    log_info "🎴 軍師（Gemini MCP）参陣確認"
else
    log_info "🎴 軍師（Gemini MCP）未設定（将軍が直接設定可能）"
fi
...
# ═══════════════════════════════════════════════════════════════════════════════
# STEP 5: multiagentセッション作成（9ペイン：karo + ashigaru1-8）
# ═══════════════════════════════════════════════════════════════════════════════
...
echo "     │  + 軍師 (GUNSHI/Gemini MCP) │  ← 参謀・相談役（MCP経由）"
echo "     └─────────────────────────────┘"
echo ""
